...
(4, '20240315T085215341Z120535.jpg', 1, '#21c7ca');
...
(1, 3, 2, 35000, 31000, '2024-03-09 07:42:13'),
...
(7, 1, 3, 17000, '2024-03-15 08:51:30');
...
(13, 'priyanka', 'priyanka@gmail.com', '1234567890', '12345', 'kk.png', 'F', 'indian', 1, '2024-04-06 15:04:05');
...
--
ALTER TABLE `myorder`
  ADD CONSTRAINT `myorder_ibfk_1` FOREIGN KEY (`sid`) REFERENCES `student` (`id`),
  ADD CONSTRAINT `myorder_ibfk_2` FOREIGN KEY (`cid`) REFERENCES `course` (`id`);
